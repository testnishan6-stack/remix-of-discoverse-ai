          ...
          {step === "profile-complete" ? (
            ...
            <>
              ...
              <div className="flex gap-1 bg-secondary rounded-lg p-1 mb-5">
                <button
                  onClick={() => { setAuthMethod("phone"); setError(""); setPhoneError(""); setStep("method"); }}
                  className={`flex-1 h-9 rounded-md text-sm font-medium transition-colors ${authMethod === "phone" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
                >
                  Phone
                </button>
                <button
                  onClick={() => { setAuthMethod("email"); setError(""); setPhoneError(""); setStep("method"); }}
                  className={`flex-1 h-9 rounded-md text-sm font-medium transition-colors ${authMethod === "email" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
                >
                  Email
                </button>
              </div>
              ...
              <p className="text-center text-sm text-muted-foreground mt-5">
                ...
                <button onClick={() => { setIsSignUp(!isSignUp); setError(""); setMessage(""); setPhoneError(""); }} className="text-accent font-medium hover:underline">
